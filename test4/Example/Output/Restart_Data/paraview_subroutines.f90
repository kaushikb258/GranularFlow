...
!*****************************************************************************
        ...
        implicit none
         ...
         real(kind=8) :: uvw(1:imax,1:jmax,1:3)
         integer :: i, j, k
         ...
         uvw(1:imax,1:jmax,3) = prim(1:imax,1:jmax,4)
